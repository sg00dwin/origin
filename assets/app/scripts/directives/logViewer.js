        ...
        controller: [
          ...
          function($scope) {
            ...
            APIDiscovery
              ...
              var setScrollableDebounced = _.debounce(setScrollable, 200);
              ...
              $win.on('resize', setScrollableDebounced);
              $scope.$on('$destroy', function() {
                $win.off('resize', setScrollableDebounced);
              });
          }
        ],
        require: 'logViewer',
